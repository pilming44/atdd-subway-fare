...
# 천당선 : 2000원
  ...
  Scenario: 성인이 두 역의 가장 빠른 도착 경로를 조회한다 (10km이하)
    Given 이메일 "adult@naver.com"과 비밀번호 "3333"로 로그인하고
    When 회원이 "202501130550" "교대역"과 "양재역"의 가장 빠른 도착 경로를 조회하면
    Then "교대역,강남역,양재역" 경로가 조회된다
    And 총 거리 20 응답한다
    And 소요 시간 6 응답한다
    And 이용 요금 1250 응답한다
  ...
  Scenario: 성인이 두 역의 가장 빠른 도착 경로를 조회한다 (10km이하)
    Given 이메일 "adult@naver.com"과 비밀번호 "3333"로 로그인하고
    When 회원이 "202501130604" "교대역"과 "양재역"의 가장 빠른 도착 경로를 조회하면
    Then "교대역,남부터미널역,양재역" 경로가 조회된다
    And 총 거리 5 응답한다
    And 소요 시간 10 응답한다
    And 이용 요금 1250 응답한다
  ...
  Scenario: 성인이 두 역의 가장 빠른 도착 경로를 조회한다 (10km이하)
    Given 이메일 "adult@naver.com"과 비밀번호 "3333"로 로그인하고
    When 회원이 "202501132300" "교대역"과 "양재역"의 가장 빠른 도착 경로를 조회하면
    Then "교대역,남부터미널역,양재역" 경로가 조회된다
    And 총 거리 5 응답한다
    And 소요 시간 10 응답한다
    And 이용 요금 1250 응답한다
  ...
  Scenario: 성인이 두 역의 가장 빠른 도착 경로를 조회한다 (10km이하)
    Given 이메일 "adult@naver.com"과 비밀번호 "3333"로 로그인하고
    When 회원이 "202501132301" "교대역"과 "양재역"의 가장 빠른 도착 경로를 조회하면
    Then "교대역,강남역,양재역" 경로가 조회된다
    And 총 거리 20 응답한다
    And 소요 시간 6 응답한다
    And 이용 요금 1250 응답한다
